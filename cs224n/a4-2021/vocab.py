...
class Vocab(object):
    ...
    def load(file_path: str) -> 'Vocab':
        ...
        file_path = abspath(f'{dirname(__file__)}/{file_path}')
...
if __name__ == '__main__':
    ...
    src_sents = get_vocab_list(args['--train-src'], source='./outputs/src', vocab_size=21000)
    tgt_sents = get_vocab_list(args['--train-tgt'], source='./outputs/tgt', vocab_size=8000)
